...
public class ChiSquaredAttributeSplitMeasure extends AttributeSplitMeasure {
    ...
    public double computeAttributeQuality(Instances data, Attribute att) throws Exception {
        ...
        return AttributeMeasures.measureChiSquared(table);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ChiSquaredAttributeSplitMeasure measure = new ChiSquaredAttributeSplitMeasure();
        ...
        for(int attr = 0; attr < whiskeyData.numAttributes() - 1; attr++){
            ...
            System.out.println("measure 'Chi Squared' for attribute" +attribName+ "splitting diagnosis ="+infoGain);
        }
    }
}
